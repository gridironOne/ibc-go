...
import (
	...
	types "github.com/cosmos/ibc-go/v3/modules/light-clients/01-furyint/types"
	ibctesting "github.com/cosmos/ibc-go/v3/testing"
	ibctestingmock "github.com/cosmos/ibc-go/v3/testing/mock"
)

func (suite *DymintTestSuite) TestCheckHeaderAndUpdateState() {
	var (
	...
	testCases := []struct {
		...
		},
		{
			...
			setup: func(suite *DymintTestSuite) {
				...
				consensusState = types.NewConsensusState(suite.clientTime, commitmenttypes.NewMerkleRoot(suite.header.Header.GetAppHash()), suite.valsHash)
				newHeader = chainADymint.CreateDMClientHeader(chainID, int64(heightPlus5.RevisionHeight), height, suite.headerTime, suite.valSet, suite.valSet, signers)
				currentTime = suite.now
...
func (suite *DymintTestSuite) TestPruneConsensusState() {
