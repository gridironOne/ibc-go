...
func (suite *DymintTestSuite) TestMisbehaviour() {
	var furyintChain *ibctesting.TestChainDymint
	signers := []tmtypes.PrivValidator{suite.privVal}
	heightMinus1 := clienttypes.NewHeight(0, height.RevisionHeight-1)

	if suite.chainA.TestChainClient.GetSelfClientType() == exported.Dymint {
		furyintChain = suite.chainA.TestChainClient.(*ibctesting.TestChainDymint)
	} else {
		furyintChain = suite.chainB.TestChainClient.(*ibctesting.TestChainDymint)
	}

	misbehaviour := &types.Misbehaviour{
		Header1:  suite.header,
		Header2:  furyintChain.CreateDMClientHeader(chainID, int64(height.RevisionHeight), heightMinus1, suite.now, suite.valSet, suite.valSet, signers),
		ClientId: clientID,
	}
...
func (suite *DymintTestSuite) TestMisbehaviourValidateBasic() {
	...
	testCases := []struct {
	...
	}{
		{
			...
			&types.Misbehaviour{
				Header1:  suite.header,
				Header2:  furyintChain.CreateDMClientHeader(chainID, int64(height.RevisionHeight), heightMinus1, suite.now.Add(time.Minute), suite.valSet, suite.valSet, signers),
				ClientId: clientID,
			},
		...
		},
		{
			...
			&types.Misbehaviour{
				Header1:  furyintChain.CreateDMClientHeader(chainID, int64(height.RevisionHeight+5), heightMinus1, suite.now, suite.valSet, suite.valSet, signers),
		...
		},
		{
			...
			&types.Misbehaviour{
				Header1:  suite.header,
				Header2:  furyintChain.CreateDMClientHeader(chainID, int64(height.RevisionHeight), clienttypes.NewHeight(0, height.RevisionHeight-3), suite.now.Add(time.Minute), suite.valSet, bothValSet, signers),
				ClientId: clientID,
			},
			func(misbehaviour *types.Misbehaviour) error { return nil },
			true,
		},
		{
			...
			&types.Misbehaviour{
				Header1:  furyintChain.CreateDMClientHeader(chainID, int64(height.RevisionHeight), clienttypes.ZeroHeight(), suite.now.Add(time.Minute), suite.valSet, suite.valSet, signers),
				Header2:  suite.header,
				ClientId: clientID,
			},
			func(misbehaviour *types.Misbehaviour) error { return nil },
		...
		},
		{
			...
			&types.Misbehaviour{
				Header1:  suite.header,
				Header2:  furyintChain.CreateDMClientHeader(chainID, int64(height.RevisionHeight), clienttypes.ZeroHeight(), suite.now.Add(time.Minute), suite.valSet, suite.valSet, signers),
				ClientId: clientID,
			},
			func(misbehaviour *types.Misbehaviour) error { return nil },
			false,
		...
		// 	&types.Misbehaviour{
		// 		Header1:  furyintChain.CreateDMClientHeader(chainID, int64(height.RevisionHeight), heightMinus1, suite.now.Add(time.Minute), suite.valSet, nil, signers),
		// 		Header2:  suite.header,
		// 		ClientId: clientID,
		// 	},
		// 	func(misbehaviour *types.Misbehaviour) error { return nil },
		...
		// 	&types.Misbehaviour{
		// 		Header1:  suite.header,
		// 		Header2:  furyintChain.CreateDMClientHeader(chainID, int64(height.RevisionHeight), heightMinus1, suite.now.Add(time.Minute), suite.valSet, nil, signers),
		// 		ClientId: clientID,
		// 	},
		// 	func(misbehaviour *types.Misbehaviour) error { return nil },
		// 	false,
		...
		},
		{
			...
			&types.Misbehaviour{
				Header1:  suite.header,
				Header2:  furyintChain.CreateDMClientHeader("ethermint", int64(height.RevisionHeight), heightMinus1, suite.now, suite.valSet, suite.valSet, signers),
				ClientId: clientID,
			},
			func(misbehaviour *types.Misbehaviour) error { return nil },
			false,
		},
		{
			...
			&types.Misbehaviour{
				Header1:  suite.header,
				Header2:  furyintChain.CreateDMClientHeader(chainID, 6, clienttypes.NewHeight(0, height.RevisionHeight+1), suite.now, suite.valSet, suite.valSet, signers),
				ClientId: clientID,
			},
			func(misbehaviour *types.Misbehaviour) error { return nil },
			false,
		},
		{
			...
			&types.Misbehaviour{
				Header1:  furyintChain.CreateDMClientHeader(chainID, int64(height.RevisionHeight), heightMinus1, suite.now, bothValSet, suite.valSet, bothSigners),
				Header2:  suite.header,
				ClientId: clientID,
			},
		...
		},
		{
			...
			&types.Misbehaviour{
				Header1:  suite.header,
				Header2:  furyintChain.CreateDMClientHeader(chainID, int64(height.RevisionHeight), heightMinus1, suite.now, bothValSet, suite.valSet, bothSigners),
				ClientId: clientID,
			},
			func(misbehaviour *types.Misbehaviour) error {
				// voteSet contains only altVal which is less than 2/3 of total power (height/1height)
