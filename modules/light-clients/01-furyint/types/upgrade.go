...
func (cs ClientState) VerifyUpgradeAndUpdateState(
	...
	// upgraded client state and consensus state must be IBC furyint client state and consensus state
	// this may be modified in the future to upgrade to a new IBC furyint type
