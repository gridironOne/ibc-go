...
// This is useful when validating whether a packet has reached the time specified delay period in the furyint client's
...
// GetProcessedTime gets the time (in nanoseconds) at which this chain received and processed a furyint header.
...
// This is useful when validating whether a packet has reached the specified block delay period in the furyint client's
// verification functions
...
// GetProcessedHeight gets the height at which this chain received and processed a furyint header.
...
// as this is internal furyint light client logic.
