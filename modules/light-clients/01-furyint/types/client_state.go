...
// Status returns the status of the furyint client.
// The client may be:
...
func (cs ClientState) Validate() error {
	...
	// between the furyint version being run by the counterparty chain
	// and the furyint version used by this light client.
	...
	if cs.LatestHeight.RevisionHeight == 0 {
		return sdkerrors.Wrapf(ErrInvalidHeaderHeight, "furyint client's latest height revision height cannot be zero")
	}
